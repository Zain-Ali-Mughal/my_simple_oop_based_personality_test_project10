...
class PersonalityTest {
  private name: string; // Private property to store the user's name
  private personalityType: string; // Private property to store the determined personality type
  ...
  private displayTitleMessage(): void {
  ...
  private async askQuestion(): Promise<void> {
    ...
    console.log(chalk.blue("----------------------------------")); // Separator line
    console.log(
      chalk.green(`You have selected: ${response.personalityQuestion}`)
    ); // Showing the selected statement
    console.log(chalk.blue("----------------------------------")); // Separator line
  }
  ...
  private showResult(): void {
    ...
    console.log(
      chalk.bgMagenta.white.bold(
        `Your Name is: ${this.name} and your personality type is: ${this.personalityType}`
      )
    ); // Displaying the user's name and personality type with styling
    console.log(chalk.blue("----------------------------------")); // Separator line
  }
}
